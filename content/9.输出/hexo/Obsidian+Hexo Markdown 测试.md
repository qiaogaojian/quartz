...
updated: "2024-11-11T05:57:09.977Z"
categories:
  - "输出"
  - "hexo"
tags:
...
[本地文件链接](ide-eval-resetter.zip)

```
[链接](链接地址)  
[obsidian双链](obsidian双链.html)
```
...
![Pasted image 20221009213236.png](Pasted image 20221009213236.png.html)

![](/images/0-2.png)
```
![](远程图片地址)
![obsidian 图片](obsidian 图片.html)
![](obsidian 本地图片名字)
```
...
> 注: Latex语法参考[常用 LaTeX 公式符号](常用 LaTeX 公式符号.html)
